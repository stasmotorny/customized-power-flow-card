...
![GitHub total downloads](https://img.shields.io/github/downloads/flixlix/energy-flow-card-plus/total?style=flat-square)
...
> [!TIP]
> 📖 **Full documentation: [cards.flixlix.com/energy-flow-card-plus](https://cards.flixlix.com/energy-flow-card-plus)**
>
...
>
> - [Installation](https://cards.flixlix.com/energy-flow-card-plus/installation)
> - [Configuration reference](https://cards.flixlix.com/energy-flow-card-plus/configuration)
> - [Interactive configurator](https://cards.flixlix.com/energy-flow-card-plus/configurator)
> - [Examples](https://cards.flixlix.com/energy-flow-card-plus/examples)

> [!NOTE]
> This card is distributed via [flixlix/energy-flow-card-plus](https://github.com/flixlix/energy-flow-card-plus), but the source code lives in the monorepo at [flixlix/flixlix-cards](https://github.com/flixlix/flixlix-cards). Issues and feature requests will be tracked there going forward.
...
The Goal of this card is to provide an easy to understand and visualize way of displaying the current Energy Distribution coming from and to different sources, such as solar, grid, home batteries etc. Furthermore, this card aims to expose a lot of customizability and control of its behavior to the configuration, allowing users to tailor it to their specific requirements.

## Scope

This card is designed to display selected-period Energy Values.

## Guides

In case you want to watch a tutorial instead of reading through this very long readme 😅, I recommend the following videos:

- [Energy Flow Card Plus in Home Assistant - Jetzt noch besser? Anleitung from Smartzeug](https://youtu.be/PUOU5qdhMro) - _in german_, up to date with version 0.2.2
- [Energy Flow Card Plus for Home Assistant from Speak to the Geek](https://youtu.be/C4Zh35E9wJE?si=REuWZxmfF91G0Ht7) - _changes in indvidual configuration_

## Installation

### HACS (recommended)

[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=flixlix&repository=energy-flow-card-plus&category=Dashboard)
...
After having HACS installed, simply search for "Energy Flow Card Plus" and download it using the UI 🙂
...
> [!IMPORTANT]
> The reference below is kept for offline reading. The **canonical, easier-to-navigate version is at [cards.flixlix.com/energy-flow-card-plus/configuration](https://cards.flixlix.com/energy-flow-card-plus/configuration)** — with grouped options, an interactive configurator, and copy-pasteable examples.

> [!WARNING]  
> This card offers a **LOT** of configuration options. Don't worry, if you want your card's appearance to match the official Energy Flow Card, you will only need to setup the entities. The rest of the options only enable further customization. If this is your goal, please go to [Minimal Configuration](#minimal-configuration) or the [Examples page](https://cards.flixlix.com/energy-flow-card-plus/examples) on the docs site.
...
At least one of _grid_, _battery_, or _solar_ is required. All entites (except _battery_charge_) should have a `unit_of_measurement` attribute of Wh(watt-hours) or kWh(kilowatt-hours).
...
| display_zero_state  | `boolean`             | `true`          | If set to `true`, the state will be shown even if it is `0`. If set to `false`, the state will be hidden if it is `0`.                                                                                                                                                                                                                                                                                                                                         |
| state_type          | `string`              | `power`         | The type of state to use for the entity. Can be `power` or `percentage`. When set to `power` the state will be the amount of energy from the grid that is low-carbon. When set to `percentage` the state will be the percentage of energy from the grid that is low-carbon.                                                                                                                                                                                    |
...
![2023-03-26-13-04-07](https://user-images.githubusercontent.com/61006057/227771568-78497ecc-e863-46f2-b29e-e15c7c20a154.gif)
![recording_multi_indiv](https://github.com/flixlix/energy-flow-card-plus/assets/61006057/337b921c-306c-4447-9c6f-1b4b72579731)
...
![ui-editor](https://github.com/flixlix/energy-flow-card-plus/assets/61006057/a5d0cbb4-f430-4ba0-9c6f-8c93689206d7)
...
- Fill the circles [#89](https://github.com/flixlix/energy-flow-card-plus/issues/89)
- [x] More than two Individual Devices [#54](https://github.com/flixlix/energy-flow-card-plus/issues/54)
- More than one solar source [#23](https://github.com/flixlix/energy-flow-card-plus/issues/23)
- Display Connected/Disconnected status [#111](https://github.com/flixlix/energy-flow-card-plus/issues/111)
- Grid Feed In Circle [#119](https://github.com/flixlix/energy-flow-card-plus/issues/119)
- Improve performance [#144](https://github.com/flixlix/energy-flow-card-plus/issues/144)
